...
# Example: Jaise agar n mein user ne ki 6 daala hai toh 6 baar input lo. n ki value Kitni baar input lein?
#  waali line mein input li gai hai. Sum 179 isliye likha hai kyunki 10+1+56+89+11+12 ka result 179 hai.
...
n=int(input("kitani bar enter kare"))
i=0
sum=0
while i<n:
    num=int(input("age dalo"))
    sum=sum+num
    i+=1
print(sum)
